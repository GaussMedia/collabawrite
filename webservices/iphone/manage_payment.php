...
<input type="hidden" id="dbtable" value="pay_amount" />
      ...
      <table class="table table-bordered table-striped data-table">
        ...
        <tr class="gradeA">
          <td class="tc"><input type="checkbox" class="checkbox"  name='chkall[]' value="<?php echo $fetch[$i]['id'];?>" />
            <?php
                  //echo $fetch['id'];?></td>
          <td><?php echo ucwords($fetch[$i]['payment_type']); ?></td>
		   <td><?php echo '$'.ucwords($fetch[$i]['amount']); ?></td>
                    <td><?php echo $fetch[$i]['text']   ; ?></td>
                   <td class="center"><?php
...
<!--              <span>
          ...
          <!-- --><span>
          <a href="index.php?mode=edit_payment&id=<?php echo base64_encode($fetch[$i]['id']); ?>">
