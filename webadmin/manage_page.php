...
<input type="hidden" id="dbtable" value="page" />
  <div class="widget-header"> <span class="icon-list"></span>
    ...
    <span>
    <a href="index.php?mode=add_page">
    <button type="button" class="btn btn-error">Add Page</button>
    </a>
    </span>
  </div>
  <!-- .widget-header -->
 ...
 ?>
      ...
      <table class="table table-bordered table-striped data-table" id="tbl1">
        ...
        <tr class="gradeA">
          ...
          <td>
		  <?php echo substr($fetch[$i]['page_des'],'0','80')."..."; ?>
          <a href="#">read more</a>
          </td>
          <td class="center"><?php
...
<?php
          ...
          <!-- Edit Button-->
          <span>
          <a href="index.php?mode=edit_page&page_id=<?php echo base64_encode($fetch[$i]['id']); ?>">
