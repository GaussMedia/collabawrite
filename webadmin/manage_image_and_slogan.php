...
<input type="hidden" id="dbtable" value="imageslogan" />
 ...
 ?>
      ...
      <table class="table table-bordered table-striped data-table" id="tbl1">
        ...
        <tr class="gradeA">
          ...
          <td>
		  <?php echo substr($fetch[$i]['slogan'],'0','50')."..."; ?>
          <a href="#">read more</a>
          </td>
           <td><img width="100px" height="130px" src="upload/sloganimage/thumb/<?php echo $fetch[$i]['image']; ?>" /></td>
          <td class="center"><?php
...
<?php
          ...
          <!-- Edit Button-->
          <span>
          <a href="index.php?mode=edit_image_and_slogan&edit=<?php echo base64_encode($fetch[$i]['id']); ?>">
