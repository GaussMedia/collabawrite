...
if($_POST['submit'])
{
	...
	$location=$_FILES['image']['tmp_name'];
        $path="upload/collection/original/";
        $thumb_path="upload/collection/thumb/";
 	if($filetype != '')
	{
...
echo '<meta http-equiv="refresh" content="2;url=index.php?mode=manage_collections" >';
    ...
    <form method="post"  class="" action="" name="frm1" enctype="multipart/form-data">
      ...
      <div class="field-group">
        ...
        <div class="field">
          ...
          <img src="upload/collection/original/<?php echo $fetch['image']; ?>" width="100" height="120" /> </div>
      </div>
      <!-- .field-group -->
