...
<script type="text/javascript" >
  // Editor of Post
    ...
    var pname = Math.floor(Math.random() * 99999999999999);
    jQuery('.post').append('<p name="'+pname+'">Type your post</p>');
...
//$(document).ready(function(){
    function onFileLoad(e) { 
            ...
            //$("#post").append(' <div id="columns" ><div id="column2" class="column ui-sortable"><div class="widget"><div class="widget-head"  style="cursor: move;"><img src="'+e.target.result +'"/></div></div></div><div id="column3" class="column ui-sortable"></div><div id="column4" class="column ui-sortable"></div></div></div>');
           $('.img_show').append('<img src="'+e.target.result +'"/>');
          // $('.img_hover_box').append('<span>(drag image)</span>');
//               $("#post").append('<div id="columns">\
//        \
        ...
        jQuery(document).ready(function() {
                ...
                jQuery("#post").blur(function(){
                    ...
                    if(jQuery(this).find('p').html() == "" || jQuery(this).html() =='Type your post' || jQuery(this).html()== '<br>' || jQuery(this).html()== '<br><br>' || jQuery(this).html()== '<br><br><br>' || jQuery(this).html()== '<br><br><br><br>'|| jQuery(this).html()== '<br><br><br><br><br>'|| jQuery(this).html()== '<br><br><br><br><br>' ) {
                        var poname = 1+ Math.floor(Math.random() * 99999999999999);
                        jQuery('#post').html('<p name="'+poname+'">Type your post</p>')
                        jQuery(this).removeClass('diss');
                    }
                });
...
//            });
       ...
       //jQuery(document).on('keyup','#linktab',function(e){
        ...
        //jQuery('.pinkLink').attr('target' , '_blank');   
