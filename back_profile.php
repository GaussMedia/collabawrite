...
<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
    ...
    <div class="pepl text-center">
      ...
      <div class="cover_table">
   	...
   	<div class="cover_row">
          ...
          //{
            ...
            <form style="border: 2px dotted; left: 2%;position: absolute;top: 15px; width: 95%; min-height: 166px; height:276px; display:none;" id="imageform" action="cover_upload" method="post" enctype="multipart/form-data">
     ...
     ?>
         ...
         ?>
          <img class="media-object img-polaroid pading2" src="webadmin/upload/userprofile/original/<?php echo $sessionuser['image'];?>" alt="">
          <?php
     }
 }
              }
    ...
    <h2 class="zero_margin">
        <a href="post_more?post=<?php echo base64_encode($fetch_ep['id']);?>">
            <?php echo ucwords($fetch_ep['title']); ?>
<!--            When Good Design Isn't Enough-->
        </a> </h2>
    <small class="light_grey">  in <a href="collection?collection_name=<?php echo $fetch_p['id'];?>"> <?php echo $fetch_p['collection_name']; ?></a></small>
    ...
    $fetch_post=$obj->fetch_one('drafts',"`id`='".$fetch_rqm['recommend_post']."'");
      ...
      if($i%4 == 0)
      {
          ...
          ?>
            ...
            <div class="span4">
<p><a href="post_more?post=<?php echo base64_encode($fetch_post['id']);?>"><strong><?php echo substr($fetch_post['title'],'0','31'); ?></strong></a></p>
            <p><a href="collection.php?collection_name=<?=$fetch_collec['id'];?>" class="light_grey">in <?php echo $fetch_collec['collection_name']; ?></a></p>
             </div>
<?php
            }
